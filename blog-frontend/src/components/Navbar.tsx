...
import { PenTool, Layout, LogOut, Plus, Compass, Settings, Bell, ChevronDown, BarChart2, Sun, Moon, CheckCircle, AlertCircle, Info } from 'lucide-react';
        ...
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className={`hidden md:flex items-center px-4 py-2 text-sm font-medium transition-all duration-200 rounded-full border ${isActive('/explore')
