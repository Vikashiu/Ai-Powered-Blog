                    ...
                    <div className="w-full md:w-64 flex-shrink-0 space-y-2">
                        {tabs.map(tab => (
                            <button
                                ...
                                className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors ${activeTab === tab.id ? 'bg-white dark:bg-white/10 text-orange-600 dark:text-white shadow-sm dark:shadow-none' : 'text-neutral-500 dark:text-neutral-400 hover:bg-neutral-100 dark:hover:bg-white/5 hover:text-black dark:hover:text-white'
                                    }`}
                            >
                                <tab.icon size={18} />
                                {tab.label}
